    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600">
          Or{" "}
          <Link href="/signup" className="font-medium text-amazon-blue hover:text-amazon-dark">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white py-8 px-4 shadow-sm rounded-2xl sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-amazon-blue focus:border-amazon-blue sm:text-sm text-gray-900"
            ...
            <div>
              ...
              <div className="mt-1 relative">
                <input
                  ...
                  className="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-lg placeholder-gray-400 focus:outline-none focus:ring-amazon-blue focus:border-amazon-blue sm:text-sm pr-10 text-gray-900"
                  placeholder="••••••••"
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-sm">
                <Link href="/forgot-password" className="font-medium text-amazon-blue hover:text-amazon-dark">
          ...
          <div className="mt-6">
            <Link
              href="/"
              className="flex items-center justify-center text-sm text-gray-500 hover:text-gray-900"
            >
