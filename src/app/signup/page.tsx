...
import { ShoppingBag, Eye, EyeOff, Loader2, ArrowLeft, CheckCircle } from "lucide-react";
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
        <div className="text-center py-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">Redirecting you to the app...</p>
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-gray-600 dark:text-gray-400">
          Or{" "}
          <Link href="/login" className="font-medium text-amazon-blue hover:text-amazon-blue/80 dark:text-blue-400 dark:hover:text-blue-300">
